...
const (
	SimulationService_SimulateBundle_FullMethodName = "/simulator.SimulationService/SimulateBundle"
)
...
type SimulationServiceClient interface {
	SimulateBundle(ctx context.Context, in *BundleRequest, opts ...grpc.CallOption) (*BundleResponse, error)
}
...
func (c *simulationServiceClient) SimulateBundle(ctx context.Context, in *BundleRequest, opts ...grpc.CallOption) (*BundleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BundleResponse)
	err := c.cc.Invoke(ctx, SimulationService_SimulateBundle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimulationServiceServer interface {
	SimulateBundle(context.Context, *BundleRequest) (*BundleResponse, error)
...
func (UnimplementedSimulationServiceServer) SimulateBundle(context.Context, *BundleRequest) (*BundleResponse, error) {
...
func _SimulationService_SimulateBundle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BundleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimulationServiceServer).SimulateBundle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SimulationService_SimulateBundle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimulationServiceServer).SimulateBundle(ctx, req.(*BundleRequest))
	}
...
var SimulationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "simulator.SimulationService",
	HandlerType: (*SimulationServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SimulateBundle",
			Handler:    _SimulationService_SimulateBundle_Handler,
		},
	},
